...
describe WordAnalysis do
  ...
  describe '#word_count' do
    ...
    it 'calculates the count of each word' do
      expect(wordanalysis.word_count).to eql([["hi", 3], ["bye", 2], ["ipsum", 1], ["lorem", 1]])
    end
  end
  ...
  describe '#letter_count' do
    ...
    it 'calculates the count of each letter' do
      expect(wordanalysis.letter_count).to eql([["j", 8], ["o", 6], ["h", 4], ["g", 4], ["k", 1], ["i", 1]])
    end
  end
  ...
  describe '#common_letters' do
    ...
    let(:count) { wordanalysis.letter_count }
